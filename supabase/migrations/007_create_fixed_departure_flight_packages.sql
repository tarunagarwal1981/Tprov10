-- ============================================================================
-- FIXED DEPARTURE FLIGHT PACKAGE TABLES
-- This migration creates tables for fixed departure flight packages
-- Structure is identical to multi-city flight packages but for fixed departure tours
-- ============================================================================

-- ============================================================================
-- 1. CREATE MAIN FIXED DEPARTURE FLIGHT PACKAGES TABLE
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS fixed_departure_flight_package_cities (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  package_id UUID NOT NULL REFERENCES fixed_departure_flight_packages(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS fixed_departure_flight_package_city_hotels (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  city_id UUID NOT NULL REFERENCES fixed_departure_flight_package_cities(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS fixed_departure_flight_package_day_plans (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  package_id UUID NOT NULL REFERENCES fixed_departure_flight_packages(id) ON DELETE CASCADE,
  city_id UUID REFERENCES fixed_departure_flight_package_cities(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS fixed_departure_flight_package_day_flights (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  day_plan_id UUID NOT NULL REFERENCES fixed_departure_flight_package_day_plans(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS fixed_departure_flight_pricing_packages (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  package_id UUID NOT NULL REFERENCES fixed_departure_flight_packages(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS fixed_departure_flight_pricing_vehicles (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS fixed_departure_flight_package_inclusions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  package_id UUID NOT NULL REFERENCES fixed_departure_flight_packages(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS fixed_departure_flight_package_exclusions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  package_id UUID NOT NULL REFERENCES fixed_departure_flight_packages(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS fixed_departure_flight_package_addons (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  package_id UUID NOT NULL REFERENCES fixed_departure_flight_packages(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS fixed_departure_flight_package_cancellation_tiers (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  package_id UUID NOT NULL REFERENCES fixed_departure_flight_packages(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_fixed_departure_flight_packages_operator ON fixed_departure_flight_packages(operator_id);
CREATE INDEX IF NOT EXISTS idx_fixed_departure_flight_packages_status ON fixed_departure_flight_packages(status);
CREATE INDEX IF NOT EXISTS idx_fixed_departure_flight_packages_published ON fixed_departure_flight_packages(published_at) WHERE status = 'published';

CREATE INDEX IF NOT EXISTS idx_fixed_departure_flight_package_cities_package ON fixed_departure_flight_package_cities(package_id);
CREATE INDEX IF NOT EXISTS idx_fixed_departure_flight_package_city_hotels_city ON fixed_departure_flight_package_city_hotels(city_id);
CREATE INDEX IF NOT EXISTS idx_fixed_departure_flight_package_day_plans_package ON fixed_departure_flight_package_day_plans(package_id);
CREATE INDEX IF NOT EXISTS idx_fixed_departure_flight_package_day_flights_day_plan ON fixed_departure_flight_package_day_flights(day_plan_id);

CREATE INDEX IF NOT EXISTS idx_fixed_departure_flight_pricing_packages_package ON fixed_departure_flight_pricing_packages(package_id);
CREATE INDEX IF NOT EXISTS idx_fixed_departure_flight_pricing_vehicles_pricing ON fixed_departure_flight_pricing_vehicles(pricing_package_id);

CREATE INDEX IF NOT EXISTS idx_fixed_departure_flight_package_inclusions_package ON fixed_departure_flight_package_inclusions(package_id);
CREATE INDEX IF NOT EXISTS idx_fixed_departure_flight_package_exclusions_package ON fixed_departure_flight_package_exclusions(package_id);
CREATE INDEX IF NOT EXISTS idx_fixed_departure_flight_package_addons_package ON fixed_departure_flight_package_addons(package_id);
CREATE INDEX IF NOT EXISTS idx_fixed_departure_flight_package_cancellation_package ON fixed_departure_flight_package_cancellation_tiers(package_id);
...
CREATE OR REPLACE FUNCTION update_fixed_departure_flight_packages_updated_at()
RETURNS TRIGGER AS $$
BEGIN
  NEW.updated_at = NOW();
  RETURN NEW;
...
DROP TRIGGER IF EXISTS trigger_update_fixed_departure_flight_packages_updated_at ON fixed_departure_flight_packages;
CREATE TRIGGER trigger_update_fixed_departure_flight_packages_updated_at
  BEFORE UPDATE ON fixed_departure_flight_packages
  FOR EACH ROW
  EXECUTE FUNCTION update_fixed_departure_flight_packages_updated_at();

-- Update timestamp trigger for hotels
CREATE OR REPLACE FUNCTION update_fixed_departure_flight_package_city_hotels_updated_at()
RETURNS TRIGGER AS $$
BEGIN
  NEW.updated_at = NOW();
  RETURN NEW;
...
DROP TRIGGER IF EXISTS trigger_update_fixed_departure_flight_package_city_hotels_updated_at ON fixed_departure_flight_package_city_hotels;
CREATE TRIGGER trigger_update_fixed_departure_flight_package_city_hotels_updated_at
  BEFORE UPDATE ON fixed_departure_flight_package_city_hotels
  FOR EACH ROW
  EXECUTE FUNCTION update_fixed_departure_flight_package_city_hotels_updated_at();
...
DO $$
BEGIN
  RAISE NOTICE '✅ Fixed departure flight package tables created successfully!';
  RAISE NOTICE 'Tables created:';
  RAISE NOTICE '  - fixed_departure_flight_packages';
  RAISE NOTICE '  - fixed_departure_flight_package_cities';
  RAISE NOTICE '  - fixed_departure_flight_package_day_plans';
  RAISE NOTICE '  - fixed_departure_flight_package_day_flights';
  RAISE NOTICE '  - fixed_departure_flight_pricing_packages';
  RAISE NOTICE '  - fixed_departure_flight_pricing_vehicles';
  RAISE NOTICE '  - fixed_departure_flight_package_inclusions';
  RAISE NOTICE '  - fixed_departure_flight_package_exclusions';
  RAISE NOTICE '  - fixed_departure_flight_package_addons';
  RAISE NOTICE '  - fixed_departure_flight_package_cancellation_tiers';
END $$;
