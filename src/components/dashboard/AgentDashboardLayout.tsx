...
export function AgentDashboardLayout({ children }: AgentDashboardLayoutProps) {
  ...
  React.useEffect(() => {
    ...
    window.addEventListener('agent-sidebar-toggled', onSidebarToggled as EventListener);
    return () => {
      clearTimeout(timeoutId);
      window.removeEventListener('resize', onResize);
      window.removeEventListener('agent-sidebar-toggled', onSidebarToggled as EventListener);
    };
