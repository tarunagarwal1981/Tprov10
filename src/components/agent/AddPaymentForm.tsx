...
export function AddPaymentForm({ itineraryId, open, onClose, onSuccess }: AddPaymentFormProps) {
      ...
      <Card className="w-full max-w-lg mx-4 bg-white shadow-2xl" onClick={(e) => e.stopPropagation()}>
        <CardHeader className="bg-gradient-to-r from-green-50 to-emerald-50 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <CardTitle className="text-lg font-semibold text-gray-900">Record Payment</CardTitle>
            <Button
              variant="ghost"
              size="sm"
