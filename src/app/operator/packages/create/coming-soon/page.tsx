    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white p-4 sm:p-6 lg:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <Badge 
            variant="secondary" 
            className="mb-6 bg-amber-100 text-amber-800 border-amber-200 dark:bg-amber-900/20 dark:text-amber-300 dark:border-amber-800 text-lg px-4 py-2"
          >
            ...
            <CardContent>
              <div className="text-center">
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Be the first to know when this package type becomes available!
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Link href="/operator/packages/create">
                    <Button variant="outline" className="package-button-fix">
                      Explore Other Package Types
                    </Button>
                  </Link>
                </div>
              </div>
