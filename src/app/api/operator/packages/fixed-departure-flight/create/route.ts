...
/**
 * POST /api/operator/packages/fixed-departure-flight/create
 * Create a fixed departure flight package with all related data
 */
export async function POST(request: NextRequest) {
  try {
    ...
    const packageResult = await query<{ id: string }>(
      `INSERT INTO fixed_departure_flight_packages (
    ...
    console.error('Error creating fixed departure flight package:', error);
    return NextResponse.json(
