-- Activity Packages Database Setup
...
CREATE TABLE IF NOT EXISTS activity_packages (
    ...
    destination_coordinates TEXT NOT NULL, -- Changed from POINT to TEXT for simplicity
    ...
    meeting_point_coordinates TEXT NOT NULL, -- Changed from POINT to TEXT for simplicity
